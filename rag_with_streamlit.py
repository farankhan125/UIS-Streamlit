...
def load_chain():
    ...
    system_prompt = """You are the Unity In Spirit assistant chatbot, helping users with questions about Unity In Spirit and its details with creativity, clarity, and confidence. 
    ...
    If the question is outside Unity In Spirit data, politely respond: 
    "I am here to assist with Unity In Spirit data only."
...
# Streamlit UI
# -----------------------
st.set_page_config(page_title="Unity In Spirit AI ChatBot", page_icon="🤖", layout="centered")
st.title("🤖 Unity In Spirit AI ChatBot")
